...
class Enemy(person):
	def makeEnemy(self,x,y,Matrix,array):
		...
		for i in range(x,x+2):
			for j in range(y,y+4):
				if Matrix[i][j]=='X' and Matrix[i][j]=='/' and Matrix[i][j]=='E' and Matrix[i][j]=='B':
					flag=1
					break
				else:
					pass
	...
	def moveRight(self,array,Matrix):
		x=array[0]
		y=array[1]
		if  self.checkRight(x,y,Matrix)==1 or self.checkRight(x,y,Matrix)==3:
			for i in range(x,x+2):
				for j in range(y,y+4):
					#array[i][j]=0
					Matrix[i][j]=' '
	...
	def moveLeft(self,array,Matrix):
		x=array[0]
		y=array[1]
		if  self.checkLeft(x,y,Matrix)==1 or self.checkRight(x,y,Matrix)==3:
			for i in range(x,x+2):
				for j in range(y,y+4):
				#    array[i][j]=0
					Matrix[i][j]=' '
	...
	def moveUp(self,array,Matrix):
		x=array[0]
		y=array[1]
		if  self.checkUp(x,y,Matrix)==1 or self.checkRight(x,y,Matrix)==3:
			for i in range(x,x+2):
				for j in range(y,y+4):
				#    array[i][j]=0
					Matrix[i][j]=' '
	...
	def moveDown(self,array,Matrix):
		x=array[0]
		y=array[1]
		if  self.checkDown(x,y,Matrix)==1 or self.checkRight(x,y,Matrix)==3:
			#print(1)
			for i in range(x,x+2):
				for j in range(y,y+4):
					#array[i][j]=0
